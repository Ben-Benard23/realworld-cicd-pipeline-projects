...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.51.207:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#ci-cd-pipeline-project-benardnehf', //update and provide your channel name
